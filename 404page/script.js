...
(function() {
  ...
  Game.prototype = {
    ...
    draw: function() {
      ...
      if (this.lost) {
        ...
        screen.font = "100px robotobold";
        screen.textAlign = "center";
        screen.fillStyle = "white";
        screen.fillText("Just SAD.", gameSize.width / 2, gameSize.height / 2);

        screen.font = "30px robotobold";
        screen.fillText("Points: " + kills, gameSize.width / 2, gameSize.height / 2 + 60);

        screen.fillStyle = "rgba(255, 255, 255, 1)";
        // screen.fillRect( gameSize.width / 2-300, gameSize.height / 2+100, window.innerWidth/ 3.72, window.innerHeight/8.93);
        //
        // screen.font = "26px robotobold";
        //
        // screen.fillStyle = "black";
        // screen.fillText("Play again", gameSize.width/2, gameSize.height / 2+170);

      } else {
        $("#point").text("Points: " + kills)
  ...
  Player.prototype = {
    ...
    draw: function() {
      if (this.active) {
        ...
        player_img.src ='http://kaagaz2.0.binboro.com/img/44.png';

        screen.drawImage(player_img, this.coordinates.x, this.coordinates.y, 40, 41);
    ...
    destroy: function() {
      ...
      $('.game__descrpiption').addClass('hide');
      $('.game').addClass('lost');
      $('#restart_btn').removeClass('hide');

      // $('.game__option').addClass('hide');
      // $('.game').addClass('cursor');
      // $('.game__descrpiption').addClass('hide');
      // $('.game').addClass('lost');
      var btn_restart = document.getElementById('restart_btn');
      btn_restart.addEventListener('mouseover', function() {
        $('#restart_btn').text('To make America Great again.');
      });
      btn_restart.addEventListener('mouseleave', function() {
        $('#restart_btn').text('Play again');
      });
      btn_restart.addEventListener('click', function(e) {

        $('.game__option').removeClass('hide');
        $('.game__descrpiption').removeClass('hide');
  ...
  window.addEventListener('load', function() {
    ...
    invaderAsset.src = 'http://kaagaz2.0.binboro.com/img/trump.png';
